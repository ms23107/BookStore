    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user is DefaultUser defaultUser)
                {
                    defaultUser.FirstName = Input.FirstName;
                    defaultUser.LastName = Input.LastName;
                    defaultUser.Address = Input.Address;
                    defaultUser.ZipCode = Input.ZipCode;
                    defaultUser.City = Input.City;
                }
